...
def sacar(*,saldo,valor,extrato,limite,numero_saques,limite_sques):
    excedeu_saldo = valor > saldo 
    excedeu_limites  = valor > limite 
    excedeu_saques = numero_saques > limite_sques
...
def criar_usuario(usuarios):
    ...
    print("============== Uusuário criado com sucesso ==================")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            valor = float(input("Informe o valor do deppósito:"))
